                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $page['title'] }}</td>
                            <td>
                                <span class="badge badge-{{$page['status'] == "Active" ? 'warning' : 'danger'}}">{{ $page['status'] }}</span>
                            </td>
                            <td>
                                ...
                                <a href="{{ route('admin.pages.destroy', $page['id']) }}" onclick="event.preventDefault();" class="btn btn-sm btn-danger delete-item" data-id="{{ $page['id'] }}">Delete</a>
